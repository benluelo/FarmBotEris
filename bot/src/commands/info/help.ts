...
let genericHelpEmbeds: HelpEmbedsType = Object.values(CONSTANTS.PERMISSIONS)
...
export function loadHelpEmbeds(bot: FarmBotClient) {
  ...
  let permissionsLevelToCategoryToCommandsMapMap: Record<PermissionsValues, Record<keyof typeof CONSTANTS.CATEGORIES, string[]>> =
