...
export default class Log {
   ...
   */
  static default(...args: unknown[]): void {
    console.log(
   ...
   * @param args - What you would like to log.
   */
  static connect(...args: unknown[]): void {
    console.log(
      chalk.white.bold(`${basename(get()[1].getFileName())}:`),
   ...
   * @param args - What you would like to log.
   */
  static dbconnect(...args: unknown[]): void {
    console.log(
      chalk.white.bold(`${basename(get()[1].getFileName())}:`),
   ...
   */
  static commandLoad(...args: unknown[]): void {
    console.log(
      chalk.white.bold(`${basename(get()[1].getFileName())}:`),
   ...
   */
  static directoryLoad(...args: unknown[]): void {
    console.log(
      chalk.white.bold(`${basename(get()[1].getFileName())}:`),
   ...
   * @param args - What you would like to log.
   */
  static toFile(...args: unknown[]): void {
    const errorFile = basename(get()[1].getFileName());
    console.log(
      chalk.white.bold(`${errorFile}:`),
